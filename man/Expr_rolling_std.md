...
[**Source code**](https://github.com/pola-rs/r-polars/tree/1fd6c01b862685c50e295d9b2ef690a69c3a7963/R/expr__expr.R#L2455)

## Description

Compute the rolling (= moving) standard deviation over the values in
this array. A window of length <code>window_size</code> will traverse
the array. The values that fill this window will (optionally) be
multiplied with the weights given by the <code>weight</code> vector.

## Usage

<pre><code class='language-R'>Expr_rolling_std(
  window_size,
  weights = NULL,
  min_periods = NULL,
  center = FALSE,
...
<code id="Expr_rolling_std_:_window_size">window_size</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_weights">weights</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_min_periods">min_periods</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_center">center</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_by">by</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_closed">closed</code>
</td>
<td>
...
<tr>
<td style="white-space: nowrap; font-family: monospace; vertical-align: top">
<code id="Expr_rolling_std_:_warn_if_unsorted">warn_if_unsorted</code>
</td>
<td>
