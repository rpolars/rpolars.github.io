...
[**Source code**](https://github.com/pola-rs/r-polars/tree/main/R/lazyframe__lazy.R#L1438)
...
```
    ...
    #> ╞════════════════════╪═══════╪══════╡
    #> │ optimization       ┆ 0     ┆ 10   │
    #> │ sort(Sepal.Length) ┆ 10    ┆ 7748 │
    #> │ group_by(Species)  ┆ 7752  ┆ 8192 │
    #> └────────────────────┴───────┴──────┘
...
```
    ...
    #> ╞════════════════════╪═══════╪═══════╡
    #> │ optimization       ┆ 0     ┆ 7     │
    #> │ sort(Sepal.Length) ┆ 7     ┆ 649   │
    #> │ group_by(Species)  ┆ 652   ┆ 14223 │
    #> └────────────────────┴───────┴───────┘
